...
path=Path('weather_data/weather_changsha_oct.csv')
...
first_date=datetime.strptime('2023-10-01','%Y-%m-%d')
...
#设置标题
ax.set_title("Changsha Daily High and Low Temperatures, 2023-10",fontsize=24)
